...
public class AlipayNotify {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, String publicKey) {
		...
		if (AlipayDefaultConfig.SIGN_TYPE.equals("RSA")) {
			isSign = RSA.verify(preSignStr, sign, publicKey, AlipayDefaultConfig.INPUT_CHARSET);
		}
		return isSign;
	}
	...
	private static String verifyResponse(String notify_id,String partner) {
		...
		String veryfy_url = AlipayDefaultConfig.HTTPS_VERIFY_URL + "partner=" + partner + "&notify_id=" + notify_id;
